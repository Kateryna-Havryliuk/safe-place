...
- **Google AI API key** ([get a free key here](https://aistudio.google.com/apikey))
...
1. Open `http://127.0.0.1:5003` in a browser.
2. **Register** an account or continue as **guest**.
3. Start a **text conversation** or **record a voice message**.
4. View **personalized analytics** (registered users only).

### Text Chat
- Type your message in the input field.
- Press **Enter** or click the **send** button.
- Wait for the AI response (a "Typing..." indicator is shown).

### Voice Input
1. Click the **microphone button** in the chat.
2. Record your message (minimum **0.5 seconds**).
3. The system will **transcribe**, **analyze acoustic features**, and **fuse** them with text analysis.

### Crisis Mode
If the system detects crisis indicators:
- 🔴 The interface turns **red**.
...
| `DELETE` | `/api/chat/<id>/message/<mid>` | ✓ | Delete a message |
...
| Method | Endpoint | Auth | Description |
|--------|----------|:----:|-------------|
| `POST` | `/api/talk` | ✕ | Send a text message |
| `POST` | `/api/analyze-voice` | ✕ | Analyze a voice recording |
| `POST` | `/api/save-voice-message` | ✓ | Save a voice message to DB |
...
- A range of emotions from neutral to highly distressed
...
- Largest improvement for ambiguous text with clear emotional voice cues
...
### 2. Conference Paper
> Havryliuk K., Mamchych T. **Interpreted Multimodal Rule-Based Fusion for Emotion Recognition** // *III International Scientific-Practical Conference "Problems of Computer Science, Software Modeling and Security of Digital Systems"*. — Lutsk–Svitiaz, 2026. — P. 170-171. [🔗 URL](https://apcssm.vnu.edu.ua/index.php/conf/article/view/315)
...
- 📧 [katyagko2004@gmail.com](mailto:katyagko2004@gmail.com)
- 🔗 ORCID: [0009-0006-4507-9885](https://orcid.org/0009-0006-4507-9885)
